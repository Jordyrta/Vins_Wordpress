...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'tuvinplusauxsoirees_07aa1e6483dafb612129_20230106161223_archive.zip';
        const ARCHIVE_SIZE       = '69728893';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '07aa1e6-06161223';
        const SECONDARY_PACKAGE_HASH = '609404a-06161223';
        const VERSION            = '1.5.1';
